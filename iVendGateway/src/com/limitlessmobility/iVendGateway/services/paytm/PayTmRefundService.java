...
public class PayTmRefundService {
	...
	public String getPayTmRefund(@RequestBody String refundRequest) {
		logger.info("refundTransactionRecord Method is callig!!");
...
//				response.setContentType(“application/json”);
		...
		if(checkResponse.equalsIgnoreCase("SUCCESS")) {
			try{
				...
				System.out.println("OrderId of Refundddddddddddddd.... "+responseJson.getString("orderId"));
				refundStatuss.setAppId(CommonService.getAppId(responseJson.getString("orderId")));
				refundStatuss.setPaymentRefNo(responseJson.getString("orderId"));
				refundStatuss.setStatusId(1);
				System.out.println("refundStatuss request.. "+refundStatuss);
				List<RefundSatusModel> listStatus = new ArrayList<RefundSatusModel>();
          	  	listStatus.add(refundStatuss);
...
//	        String transactionStatus = transactionController.saveTransaction(paymentTransaction);  
	...
	public String payTmStaticRefundProcess(@RequestBody String refundRequest) throws Exception {
		...
		String merchantGuid = "f979a988-5530-4e1d-b99a-18c8ed26d904";
				
		PaymentTransaction paymentTransaction = new PaymentTransaction();
		EventLogs eventLogResponse = new EventLogs();
        paymentTransaction.setTerminalId("2485cd530fe2351c");
