...
import com.limitlessmobility.iVendGateway.controller.zeta.ZetaCallbackController;
import com.limitlessmobility.iVendGateway.model.zeta.ZetaCallbackTransactions;

@Controller
@RequestMapping("/payment/v1/transactions/zeta")
public class ZetaCallbackService {
	...
	public String getZetaCallback(@RequestBody ZetaCallbackTransactions zetaCallbackTransactions) {
		...
		try {
			ZetaCallbackController zetaCallbackController = new ZetaCallbackController();
