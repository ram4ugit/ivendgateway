...
public class PhonePeQRService {
	...
	@ResponseBody
	public String createQRCode(@RequestBody PhonePeQRRequestData phonePeQRRequestModel) throws JSONException {
		...
		String pspid=phonePeQRRequestModel.getPspId();
		
		
		amount=Integer.parseInt(phonePeQRRequestModel.getAmount())*100;
		...
		String terminalId = phonePeQRRequestModel.getPosId();
		...
		String xveri = encodVal.concat(QRSTR).concat(merchantKey);
		...
		paymentInitiation.setProductPrice(phonePeQRRequestModel.getAmount());
