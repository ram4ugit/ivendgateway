...
public class PayuQrService {


	@RequestMapping(value = "/getqr", method = RequestMethod.POST)
	@ResponseBody
	public String getDynamicQr(@RequestBody CommonQRRequest commonQrResuest) throws NoSuchAlgorithmException {
		String line="";
...
//			String urlParameters = qrRequest;
	        ...
	        int operatorId = commonCredentialDao.getOperatorId(commonQrResuest.getPosId(), commonQrResuest.getPspId());
			
			operatorDetail = commonCredentialDao.getPspConfigDetailForWallet(operatorId, commonQrResuest.getPspId());
			...
			String input=""+merchantKey+"|generate_dynamic_bharat_qr|{\"transactionId\":\""+uniqueOrderId+"\",\"transactionAmount\":\""+commonQrResuest.getAmount()+"\",\"outputType\":\"string\"}|"+salt+"";
//			String input="2f8SnB|generate_dynamic_bharat_qr|{\"transactionId\":\""+uniqueOrderId+"\",\"transactionAmount\":\""+commonQrResuest.getAmount()+"\",\"outputType\":\"string\"}|LJR1BcnK";
			...
			String urlParameters = "key="+merchantKey+"&command=generate_dynamic_bharat_qr&hash="+PayUHash.getHash(input)+"&var1={\"transactionId\":\""+uniqueOrderId+"\",\"transactionAmount\":\""+commonQrResuest.getAmount()+"\",\"outputType\":\"string\"}";
