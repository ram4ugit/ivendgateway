...
@Controller
@RequestMapping(value="/commonRefund")
public class AutoRefundService {
	...
	public String autoRefundProcess(){
		commonController.autoRefundProcess();
		return "Success";
	}
	...
	@ResponseBody
	public ResponseDTO manualRefundProcess(@RequestBody ManualRefundRequest refundRequest){
